...
- WSRVThreadedBaseServlet runs each handling of GET methods to a separate thread which in turns uses threads from the same pool to browse the filesystem (this is the default one)
